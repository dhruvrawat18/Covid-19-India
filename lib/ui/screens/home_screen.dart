    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavyBar(
        ...
        items: <BottomNavyBarItem>[
          BottomNavyBarItem(
            title:
                Text('Dashboard', style: GoogleFonts.montserrat(fontSize: 12)),
            icon: Icon(Icons.dashboard),
            activeColor: Colors.red,
          ),
          BottomNavyBarItem(
            title: Text(' States', style: GoogleFonts.montserrat(fontSize: 12)),
            icon: Icon(Icons.flag),
            activeColor: Colors.indigo,
          ),
          BottomNavyBarItem(
            title: Text(' Zones', style: GoogleFonts.montserrat(fontSize: 12)),
            icon: Icon(Icons.my_location),
            activeColor: Colors.cyan,
          ),
          BottomNavyBarItem(
            title: Text(' Health', style: GoogleFonts.montserrat(fontSize: 12)),
            icon: Icon(FontAwesomeIcons.stethoscope),
            activeColor: Color(0xFF28a745),
          ),
          BottomNavyBarItem(
            title: Text(' News', style: GoogleFonts.montserrat(fontSize: 12)),
